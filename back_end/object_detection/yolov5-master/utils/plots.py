...
@threaded
def plot_images(images, targets, paths=None, fname="photos.jpg", names=None):
    ...
    bs = min(bs, max_subplots)  # limit plot photos
    ...
    for i, im in enumerate(images):
        if i == max_subplots:  # if last batch has fewer photos than we expect
            break
...
def plot_labels(labels, names=(), save_dir=Path("")):
    """Plots dataset labels, saving correlogram and label photos, handles classes, and visualizes bounding boxes."""
...
def imshow_cls(im, labels=None, pred=None, names=None, nmax=25, verbose=False, f=Path("photos.jpg")):
    """Displays a grid of photos with optional labels and predictions, saving to a file."""
