...
class Loggers:
    ...
    def on_train_batch_end(self, model, ni, imgs, targets, paths, vals):
        """Logs training batch end events, plots photos, and updates external loggers with batch-end data."""
    ...
    def on_train_end(self, last, best, epoch, results):
        ...
        if self.tb and not self.clearml:  # These photos are already captured by ClearML by now, we don't want doubles
            for f in files:
...
class GenericLogger:
    ...
    def log_images(self, files, name="Images", epoch=0):
        """Logs photos to all loggers with optional naming and epoch specification."""
