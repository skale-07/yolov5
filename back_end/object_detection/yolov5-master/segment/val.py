...
Usage:
    $ bash data/scripts/get_coco.sh --val --segments  # download COCO-segments val split (1G, 5000 photos)
...
def run(
    ...
    if not training:
        ...
        task = task if task in ("train", "val", "test") else "val"  # path to train/val/test photos
